...
const stats = [
  ...
  { icon: Palette, label: "Happy Clients", value: "10+" },
  { icon: Rocket, label: "Code Commits", value: "1K+" },
];
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6 animate-slide-in-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                With over two years of experience in the industry, I have had
                the opportunity to work on a variety of projects, ranging from
                e-commerce platforms to applications powered by artificial
                intelligence (AI).
              </p>
              <p className="text-muted-foreground leading-relaxed">
                My approach combines technical expertise with creative
                problem-solving, ensuring that every project not only meets but
                also exceeds expectations. I believe in writing clean,
                maintainable code and always staying up-to-date with the latest
